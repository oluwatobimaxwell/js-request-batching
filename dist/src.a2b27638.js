...
},{"crypt":"node_modules/crypt/crypt.js","charenc":"node_modules/charenc/charenc.js","is-buffer":"node_modules/is-buffer/index.js"}],"node_modules/uuid/dist/esm-browser/rng.js":[function(require,module,exports) {
"use strict";
...
function fetchResponses() {
  ...
  var end = batchSize - 1 + start;
  var batch = requests.filter(function (_, j) {
    return j >= start && j <= end;
  });

  if (batch.length > 0) {
    var requestData = batch.map(function (e) {
      var _e$request, _e$request$params;

      return {
        id: e.id,
        fileIds: e === null || e === void 0 ? void 0 : (_e$request = e.request) === null || _e$request === void 0 ? void 0 : (_e$request$params = _e$request.params) === null || _e$request$params === void 0 ? void 0 : _e$request$params.ids
      };
    });
    var ids = batch.map(function (e) {
      var _e$request2, _e$request2$params;

      return e === null || e === void 0 ? void 0 : (_e$request2 = e.request) === null || _e$request2 === void 0 ? void 0 : (_e$request2$params = _e$request2.params) === null || _e$request2$params === void 0 ? void 0 : _e$request2$params.ids;
    }).join().split(",").unique();
    var request = batch[0].request;
    request.params.ids = ids;
    (0, _axios.default)(request).then(function (_ref) {
      var _ref$data = _ref.data,
          data = _ref$data === void 0 ? {} : _ref$data;
      var _data$items = data.items,
          items = _data$items === void 0 ? [] : _data$items;
      runAfter(setResponses(requestData, items)).then(function () {
        setBatchIndex(end);
      });
    });
  } else {
...
function setResponses() {
  ...
  requestData.forEach(function (_ref2) {
    var _ref2$id = _ref2.id,
        id = _ref2$id === void 0 ? null : _ref2$id,
        _ref2$fileIds = _ref2.fileIds,
        fileIds = _ref2$fileIds === void 0 ? [] : _ref2$fileIds;
    responses.push({
      id: id,
      files: items.filter(function (e) {
        return fileIds.includes(e.id);
      })
    });
  });
  return;
...
function responseHandler(id) {
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      ...
      var response = responses.find(function (e) {
        return e.id === id;
      });
      if (!response) return resolve(responseHandler(id));

      if ((response === null || response === void 0 ? void 0 : (_response$files = response.files) === null || _response$files === void 0 ? void 0 : _response$files.length) > 0) {
        return resolve({
          data: {
...
function batchInterceptor(instance) {
  instance.interceptors.request.use(function (request) {
    ...
    var id = (0, _md.default)(JSON.stringify(request) + (0, _uuid.v4)());
    requests.push({
      request: request,
      id: id,
      time: timeStamp
    ...
    return {
      cancelToken: new _axios.CancelToken(function (cancel) {
        return cancel(id);
      })
    };
  }, function (error) {});
  instance.interceptors.response.use(function (response) {
    ...
    if ((response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : (_response$data$items = _response$data.items) === null || _response$data$items === void 0 ? void 0 : _response$data$items.length) > 0) {
    ...
    return responseHandler(error === null || error === void 0 ? void 0 : error.message);
  });
}

var _default = batchInterceptor;
exports.default = _default;
},{"axios":"node_modules/axios/index.js","md5":"node_modules/md5/md5.js","uuid":"node_modules/uuid/dist/esm-browser/index.js"}],"src/apiClient.js":[function(require,module,exports) {
"use strict";
...
function runTest() {
  var batchUrl = "/file-batch-api"; // Should return [{id:"fileid1"},{id:"fileid2"}]
